...
{   
    ofstream file;
    file.open("D:/Camino_Emerson/LA SALLE_Semestre_5_6/Fundamentos_Lenguajes(Pack)/Carpeta_Emer_ACTUAL/Proyecto Final/python_vs_golang_c--main/tiemposejecucioninsert/tiemposc++insert.txt");
    ofstream file2;
    file2.open("D:/Camino_Emerson/LA SALLE_Semestre_5_6/Fundamentos_Lenguajes(Pack)/Carpeta_Emer_ACTUAL/Proyecto Final/python_vs_golang_c--main/desviacionestandarinsert/desviacionestarc++insert.txt");
    int e[]={100,1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000,
    9000, 10000, 20000, 30000, 40000, 50000};
